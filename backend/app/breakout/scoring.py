...
def score_breakout(
    *,
    ...
    min_rvol: float = 1.5,  # synced with breakout_engine.MIN_RVOL_CONFIRM, see that file
) -> ScoreResult:
...
def score_dip_buy(
    *,
    ...
    market_regime: str,
    sector_confirmed: bool,
    min_rvol: float = 1.3,  # synced with dip_buy_engine.MIN_RVOL_CONFIRM, see that file
) -> ScoreResult:
    breakdown: dict[str, float] = {}
